...
//    const val globalInitTransformProject = ":global:lib-init:app-init-transform"
    //这三个模块被发布到本地了
    const val globalInitHandler = "com.ds.app_init:handler:1.0.9"
    const val globalInitProcessor = "com.ds.app_init:processor:1.0.9"
    const val globalInitTransform  = "com.ds.app_init:transform:1.0.9"
